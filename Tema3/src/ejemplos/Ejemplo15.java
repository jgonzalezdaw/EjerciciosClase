...
/**
 * Ejemplo de obtención del menor elemento de un array de valores, guardando en
 * una variable la posición del menor valor.
 * 
 * @author csogorb
 *
 */
public class Ejemplo15 {
	...
	public static void main(String[] args) {
		...
		System.out.println("La posición del menor elemento es " + posMin + " y el valor es " + temperaturas[posMin]);
	}
