...
public class ejCadenas {
    ...
    public static void main(String[] args) {
        ...
        // Indicamos la posicion del primer caracter dentro de la cadena introducido en indexOf
        System.out.println("Vemos la posición de la primera letra 'o': " + nombre.indexOf("o"));
         
        // Indicamos la posicion del último caracter dentro de la cadena introducido en indexOf
        ...
        // Devuelve una subcadena que corresponde a los valores beginIndex y endIndex.
        System.out.println("Vamos a ocultar el primer y último caracter de la primer cadena: " + nombre.substring(1, 4));
        ...
        System.out.println( "Juntamos las dos cadenas \n" + String.valueOf(nombre) + " " + numero);
         
        // Convertimos un String a un int 
        //  numero = numero * 2; (no deja porque no se puede multiplicar un string)
        // Lo pasamos a int
